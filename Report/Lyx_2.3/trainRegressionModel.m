...
% Auto-generated by MATLAB on 27-Jan-2025 10:42:06
...
predictorNames = {'Slenderness', 'Mach', 'Range_km_', 'Payload_kg_'};
predictors = inputTable(:, predictorNames);
response = inputTable.Weight_kg_;
isCategoricalPredictor = [false, false, false, false];

% Train a regression model
% This code specifies all the model options and trains the model.
concatenatedPredictorsAndResponse = predictors;
concatenatedPredictorsAndResponse.Weight_kg_ = response;
linearModel = fitlm(...
...
trainedModel.RequiredVariables = {'Mach', 'Payload_kg_', 'Range_km_', 'Slenderness'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.Weight_kg_ = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'interactions', ...
        'RobustOpts', 'off');
